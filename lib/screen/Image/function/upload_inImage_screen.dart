...
class UploadInImageScreen extends StatefulWidget {
  Product product;
  ...
  _UploadInImageScreenState createState() => _UploadInImageScreenState();
}

class _UploadInImageScreenState extends State<UploadInImageScreen> {
  @override
  void initState() {
    init();
    super.initState();
