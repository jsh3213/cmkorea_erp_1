...
import 'package:cmkorea_erp/screen/dataUpload/function/download_outImage_screen.dart';
...
class UploadOutImageScreen extends StatefulWidget {
  Product product;

  UploadOutImageScreen({
    Key? key,
  ...
  _UploadOutImageScreenState createState() => _UploadOutImageScreenState();
}

class _UploadOutImageScreenState extends State<UploadOutImageScreen> {
  @override
  void initState() {
    init();
    super.initState();
